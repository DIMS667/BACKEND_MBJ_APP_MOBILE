...
STORIES_SPRINT_1_DATA = [
    {
        ...
        "pages": [
            ...
            _page(2, "Je m'habille.", 6627),
            _page(3, "Je prends mon petit déjeuner.", 4626),
            _page(4, "Je prends mon sac.", 2475),
            _page(5, "J'arrive à l'école.", 16807),
        ],
    },
    {
    ...
    },
    {
        ...
        "pages": [
            ...
            _page(3, "Le médecin m'appelle.", 6561),
            _page(4, "Il m'examine doucement.", 6561),
            _page(5, "La visite est terminée.", 35547),
        ],
    },
    {
    ...
    },
    {
        ...
        "pages": [
            ...
            _page(5, "Je peux dire ce que je ressens.", 30391),
        ],
    },
    {
    ...
    },
    {
        ...
        "pages": [
            ...
            _page(3, "Un adulte m'explique le nouveau programme.", 32648),
            _page(4, "Je regarde ce qui va se passer.", 31955),
            _page(5, "Je peux essayer ce nouveau programme.", 31408),
        ],
    },
    {
    ...
    },
    {
        ...
        "pages": [
            ...
            _page(3, "J'attends mon tour.", 36914),
            _page(4, "Je respire pendant que j'attends.", 2486),
            _page(5, "Maintenant, c'est mon tour.", 35547),
        ],
    },
    {
    ...
    },
    {
        ...
        "pages": [
            ...
            _page(5, "J'écoute une histoire calme.", 25191),
            _page(6, "Je me couche pour dormir.", 6479),
        ],
    },
    {
    ...
    },
    {
        ...
        "pages": [
            ...
            _page(3, "Je frotte mes mains avec du savon.", 34826),
            _page(4, "Je rince puis je sèche mes mains.", 32464),
            _page(5, "Mes mains sont propres.", 35547),
        ],
    },
    {
